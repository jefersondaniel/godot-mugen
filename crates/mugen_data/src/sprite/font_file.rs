...
use crate::{font::{bitmap_font::BitmapFont, fnt_parser::read_fnt_v1, font::Font, mugen_font::MugenFont, properties::{FontSpacing, GlyphSpacing}, vector_font::VectorFont}, io::{file::FileReader, reader::DataReader}, text::text_file::TextFile, types::{Rect2, Vector2}};

use super::{sff::image::{Image, Palette}, sprite_file::SpriteFile};

pub fn load_mugen_font(
    reader: &mut dyn DataReader,
    path: &str,
    file_reader: &dyn FileReader,
    image_storage: &mut Arena<Image>,
    palette_storage: &mut Arena<Palette>,
) -> Result<MugenFont, Error> {
